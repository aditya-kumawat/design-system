...
import { InputMask, Popover, Label } from '@/index';
  ...
  renderCalendar() {
    ...
    return (
      <Calendar
        ...
        onRangeChange={this.onRangeChangeHandler.bind(this)}
        yearNav={yearNav}
        monthNav={monthNav}
        ...
        <Row>
          <Column size={'6'} sizeXS={'12'} className="DateRangePicker-input DateRangePicker-input--startDate">
            ...
            <InputMask
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>, val?: string) => this.onChangeHandler(e, val || '', 'start')}
              onBlur={(e: React.ChangeEvent<HTMLInputElement>, val?: string) => this.onBlurHandler(e, val || '', 'start')}
          ...
          <Column size={'6'} sizeXS={'12'} className="DateRangePicker-input DateRangePicker-input--endDate">
            ...
            <InputMask
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>, val?: string) => this.onChangeHandler(e, val || '', 'end')}
              onBlur={(e: React.ChangeEvent<HTMLInputElement>, val?: string) => this.onBlurHandler(e, val || '', 'end')}
